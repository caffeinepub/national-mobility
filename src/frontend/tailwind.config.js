  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        card: "0 4px 24px 0 oklch(var(--navy) / 0.10)",
        "card-hover": "0 16px 48px 0 oklch(var(--navy) / 0.16)",
        navy: "0 8px 32px 0 oklch(var(--navy) / 0.3)",
        teal: "0 8px 32px 0 oklch(var(--teal) / 0.3)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
